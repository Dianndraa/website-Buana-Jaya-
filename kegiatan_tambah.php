...
?>
<h2 class="sub-header">Tambah Kegiatan</h2>
<form name="tambah" method="post" action="?tampil=kegiatan_tambahproses" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4"> <input type="file" name="foto" class="form-control"></div>
        </div>
